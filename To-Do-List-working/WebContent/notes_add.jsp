...
<body class="metro"onload="focusOnLogin()">
		...
		<div style="background-color:white">
			...
			<div class="tab-control place-center" style="background-color:white;" data-role="tab-control">
				<ul class="tabs">
					<li class="active"><a href="#_page_1">ADD NOTES </a></li>
				</ul>
				<div class="frames">
					<div class="frame" id="_page_1">
						<div>
	
						<s:form action="notesAdd" id = "notesID" enctype="multipart/form-data">
							<s:textfield name="name" label="Title" id="1"></s:textfield>
							<s:textarea name = "text" label="Text"></s:textarea>	
	...
	function fnEdit(){
		...
		alert('hey');
		form = document.getElementById('notesID');
		form.submit();
	}
